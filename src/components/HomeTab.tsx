...
import { calculateTotalVolume, calculateAverageRPE, formatDisplayDate } from '../utils/calculations';
...
export const HomeTab: React.FC<HomeTabProps> = ({
  ...
  const latestSets = [...sets].sort((a, b) => b.timestamp - a.timestamp).slice(0, 5);
