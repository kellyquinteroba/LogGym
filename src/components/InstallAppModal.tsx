  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-slate-900/60 backdrop-blur-xs p-0 sm:p-4 animate-in fade-in duration-200">
      <div className="bg-white w-full sm:max-w-md rounded-t-3xl sm:rounded-2xl shadow-2xl border border-slate-100 max-h-[90vh] flex flex-col overflow-hidden">
        {/* Modal Header */}
        <div className="p-4 border-b border-slate-100 flex items-center justify-between bg-gradient-to-r from-slate-900 to-cyan-900 text-white">
        ...
        <div className="p-4 overflow-y-auto space-y-4 text-xs text-slate-600 leading-relaxed">
          {activeTab === 'pwa' ? (
            <div className="space-y-3.5">
              {isInstalled ? (
                <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-3.5 flex items-start gap-2.5 text-emerald-800">
                ...
                <div className="bg-cyan-50 border border-cyan-200 rounded-xl p-3.5 text-cyan-950">
                  <p className="font-bold text-xs">Instalación directa disponible</p>
                  <p className="text-[11px] text-cyan-800 mt-1 mb-3">
              ...
              <div className="bg-slate-50 border border-slate-200/80 rounded-xl p-3 text-[11px] text-slate-500">
                <strong className="text-slate-700">Ventaja PWA:</strong> Ocupa menos de 5 MB, se actualiza automáticamente cuando hay mejoras y tus registros de peso y repeticiones se guardan en el teléfono de forma segura.
              </div>
            </div>
          ) : (
            <div className="space-y-3.5">
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-3.5 text-slate-700 space-y-2">
              ...
              {/* Option 1: PWABuilder */}
              <div className="border border-cyan-200 bg-cyan-50/50 rounded-xl p-3.5 space-y-2.5">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] font-semibold text-[#0e7490] bg-cyan-100 px-2 py-0.5 rounded-full">Gratis y Oficial</span>
                </div>
                ...
                <div className="pt-1 flex flex-col gap-2">
                  <button
                    ...
                    className="w-full bg-white border border-slate-300 hover:bg-slate-50 text-slate-700 font-semibold py-2 px-3 rounded-lg text-xs flex items-center justify-center gap-1.5 transition-colors"
                  >
              ...
              <div className="border border-slate-200 bg-white rounded-xl p-3 space-y-1.5">
                <span className="font-bold text-xs text-slate-900 flex items-center gap-1.5">
                ...
                <p className="text-[11px] text-slate-600">
                  Para desarrolladores: puedes usar Google Bubblewrap (<code className="bg-slate-100 px-1 py-0.5 rounded text-[10px] text-slate-800">npx @bubblewrap/cli build</code>) para compilar el proyecto directamente en un binario APK o AAB para Google Play.
                </p>
              </div>
            </div>
          )}
